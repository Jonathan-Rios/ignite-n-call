  ...
  intervals: z
    ...
    .transform((intervals) => {
      return intervals.map((interval) => {
        // ? Não pegamos o enabled pois já filtramos os que estão desabilitados
        return {
    ...
    .refine(
      ...
      {
        message: "O horário de início deve ser menor que o de término!",
      }
    )
    .refine(
      (intervals) => {
...
export default function TimeIntervals() {
  ...
  const handleSetTimeIntervals = async (data: unknown) => {
    // Solução temporária para o problema de tipagem, bug de atualização do Zod
